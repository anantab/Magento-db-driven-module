...
class Book_Brands_Adminhtml_BrandsController extends Mage_Adminhtml_Controller_action
{
        ...
        {
            $this->loadLayout()->_setActiveMenu('brands/items')->_addBreadcrumb(Mage::helper('adminhtml')->__('Brands Manager'),
        ...
        public function editAction()
        {
            ...
            if ($brandsModel->getId() || $brandsId == 0) {
                ...
                $this->_addContent($this->getLayout()->
                        createBlock('brands/adminhtml_brands_edit'))->
